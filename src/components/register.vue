                ...
                <div>
                    <form @submit.prevent="register">
                        ...
                        <div class="q-gutter-sm q-py-sm">
                            <q-checkbox v-model="form.is_super" label="Label on Right" />
                        </div>
                        <div class="q-mt-sm">
                            <div>
                                <q-btn label="Register" :loading="submitting" no-caps class="q-px-lg" unelevated type="submit" color="primary"/>
                            </div>
